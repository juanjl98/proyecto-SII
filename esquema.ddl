...
CREATE TABLE CUENTAPOOLCUENTAREFERENCIA (SALDO DOUBLE, cuentaPool_id VARCHAR NOT NULL, cuentaRef_id VARCHAR NOT NULL, PRIMARY KEY (cuentaPool_id, cuentaRef_id))
...
ALTER TABLE CUENTAPOOLCUENTAREFERENCIA ADD CONSTRAINT FK_CUENTAPOOLCUENTAREFERENCIA_cuentaPool_id FOREIGN KEY (cuentaPool_id) REFERENCES CUENTA (IBAN)
ALTER TABLE CUENTAPOOLCUENTAREFERENCIA ADD CONSTRAINT FK_CUENTAPOOLCUENTAREFERENCIA_cuentaRef_id FOREIGN KEY (cuentaRef_id) REFERENCES CUENTA (IBAN)

CREATE TABLE CLIENTE (ID BIGINT NOT NULL, DTYPE VARCHAR(31), IDENTIFICACION VARCHAR, BLOQUEADO BOOLEAN, CIUDAD VARCHAR, CODIGO_POSTAL VARCHAR, DIRECCION VARCHAR, ESTADO VARCHAR, FECHA_ALTA TIMESTAMP, FECHA_BAJA TIMESTAMP, PAIS VARCHAR, TIPO_CLIENTE VARCHAR, RAZONSOCIAL VARCHAR, APELLIDOS VARCHAR, FECHANACIMIENTO TIMESTAMP, NOMBRE VARCHAR, PRIMARY KEY (ID))
...
CREATE TABLE PERSONA_AUTORIZADA (ID BIGINT NOT NULL, APELLIDO VARCHAR, BLOQUEADO BOOLEAN, DIRECCION VARCHAR, ESTADO VARCHAR, FECHA_FIN VARCHAR, FECHA_INICIO VARCHAR, FECHA_NACIMIENTO VARCHAR, IDENTIFICACION VARCHAR, NOMBRE VARCHAR, PRIMARY KEY (ID))
